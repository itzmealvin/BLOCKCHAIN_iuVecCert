...
import { getClientCertificate, sortCertificateChain } from "./certsUtils.js";
...
import { authenticateSignature, isCertsExpired } from "./verification.js";

export const verifyPDF = (pdf) => {
...
const verify = (signature, signedData, signatureMeta) => {
  ...
  if (!validAuthenticatedAttributes) {
    throw new VerifyPDFError(
      ...
      VerifyPDFError.TYPES.VERIFY_SIGNATURE,
    );
  }
