...
!(function (t, e) {
  ...
  const t = new Map(),
    ...
    u = () =>
      globalThis.jQuery && !document.body.hasAttribute("data-bs-no-jquery")
        ? globalThis.jQuery
        : null,
    f = [],
    ...
    _ = (t, e, n = !0) => {
      ...
      const o = ((t) => {
        if (!t) return 0;
        let { transitionDuration: e, transitionDelay: i } = globalThis
          .getComputedStyle(t);
  ...
  function Le(t) {
    return ((pe(t) ? t.ownerDocument : t.document) || globalThis.document)
      .documentElement;
  }
  function Se(t) {
    return "html" === ue(t)
  ...
  class qi extends W {
    ...
    static dataApiKeydownHandler(t) {
      ...
      if (e && !i) return;
      t.preventDefault();
      const s = this.matches(Ii) ? this : z.prev(this, Ii)[0] ||
          z.next(this, Ii)[0] ||
  ...
  class cn {
    ...
    getWidth() {
      ...
      return Math.abs(globalThis.innerWidth - t);
    }
    hide() {
    ...
    _setElementAttributes(t, e, i) {
      ...
      this._applyManipulationCallback(t, (t) => {
        if (t !== this._element && globalThis.innerWidth > t.clientWidth + n) {
          return;
        }
        this._saveInitialAttribute(t, e);
        const s = globalThis.getComputedStyle(t).getPropertyValue(e);
    ...
    _maybeSanitize(t) {
      return this._config.sanitize
        ? (function (t, e, i) {
          ...
          const n = new globalThis.DOMParser().parseFromString(
              t,
              "text/html",
            ),
